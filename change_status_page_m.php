...
if(isset($_POST["submit"])){
	...
	$sql = "UPDATE manufacturer_order SET status = '" . $status . "' where exp_key = " . $id;
...
<nav class="navbar navbar-inverse navbar-fixed-bottom" >
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="insert_page_m.php">Insert Page</a></li><!--改LINK + PAGE NAME -->
      <li><a href="check_page_m.html">Check Page</a></li><!--改LINK + PAGE NAME -->
...
<br><br>
   <div class="form-group">
    ...
    <select name="status" class="form-control">
	    ...
	    <option value="received by the customer">Received by the customer</option>
  </select>
  </div>
 <br><br>
